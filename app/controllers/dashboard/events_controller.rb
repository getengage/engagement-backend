  ...
  class EventsController < ApplicationController
    def show
      if @api_key = ApiKey.find_by_uuid(api_key_param)
        ...
        @top_visits_by_source_url    = @url_aggregates.top_visits
        @top_scores_by_source_url    = @url_aggregates.top_scores
        @top_referrals_by_source_url = @url_aggregates.top_referrers
